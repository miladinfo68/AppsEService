<%@ Page Title="" Language="C#" MasterPageFile="~/Adobe/MastePage/CMSAdobeMaster.Master" AutoEventWireup="true" CodeBehind="Report_MeetingsAndContents.aspx.cs" Inherits="IAUEC_Apps.UI.Adobe.CMS.Report_MeetingsAndContents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="p" runat="server" DefaultButton="btn_Search">
        <fieldset dir="rtl" style="padding: 2%" ><legend></legend>   
            <div dir="rtl"  align="center">
                <Label>نیمسال</Label>
                <telerik:RadComboBox ID="rcbTerm" runat="server"  AutoPostBack="true" ></telerik:RadComboBox><br />         
            </div >
            <br />
            <div dir="rtl"  align="center">
                <Label>تاریخ</Label>
                <asp:TextBox ID="txt_Date" runat="server" placeholder="1393/06/17"></asp:TextBox>           
            </div >
            <br />
            <div dir="rtl"  align="center">
                <Label>میزگرد</Label>
                ...
                <br />
                 <asp:RequiredFieldValidator ID="ReqValCode" ControlToValidate="txt_Code" runat="server" Display="Dynamic" ErrorMessage=" * شماره میز گرد را وارد کنید " ForeColor="Red"></asp:RequiredFieldValidator>
            </div>
            <br />
            <div dir="rtl"  align="center">
        ...
        <telerik:RadGrid ID="grd_Meetings" AllowPaging="true" PageSize="20" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" 
            ...
            <MasterTableView  >
                ...
                <Columns>
                    <telerik:GridHyperLinkColumn DataNavigateUrlFields="Link" HeaderText="لینک" Text="مشاهده" Target="_blank"></telerik:GridHyperLinkColumn>

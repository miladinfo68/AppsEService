<%@ Page Title="" Language="C#" MasterPageFile="~/Adobe/MastePage/CMSAdobeMaster.Master" AutoEventWireup="true" CodeBehind="Edit_flv.aspx.cs" Inherits="IAUEC_Apps.UI.Adobe.CMS.Edit_flv" %>
        ...
        <telerik:RadGrid ID="grd_Meetings" AllowPaging="true" PageSize="20" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" 
            OnNeedDataSource="grd_Meetings_NeedDataSource" AllowFilteringByColumn="false"  >
              <MasterTableView  >
                ...
                <Columns>
                  <telerik:GridHyperLinkColumn DataNavigateUrlFields="Link" HeaderText="لینک"  Text="ویرایش" Target="_blank"></telerik:GridHyperLinkColumn>

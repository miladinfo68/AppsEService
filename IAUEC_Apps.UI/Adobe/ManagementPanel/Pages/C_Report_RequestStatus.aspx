<%@ Page Title="" Language="C#" MasterPageFile="~/Adobe/MastePage/AdobeCMS.Master" AutoEventWireup="true" CodeBehind="C_Report_RequestStatus.aspx.cs" Inherits="IAUEC_Apps.UI.Adobe.ManagementPanel.Pages.C_Report_RequestStatus" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <asp:Label ID="lbl_Status" runat="server" Text="انتخاب وضعیت درخواست"></asp:Label>
    ...
    <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" Skin="Default"
    ...
    <div runat="server" id="InfoUser" visible="false">
        <telerik:RadGrid ID="RadGrid3" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" Skin="Default">        
            <MasterTableView Dir="RTL">
                <ItemStyle BackColor="#e6ffff" Font-Names="tahoma" />
                <HeaderStyle Font-Names="tahoma" />
                <AlternatingItemStyle Font-Names="tahoma" />
    ...
    <div runat="server" id="InfoClassDayTime" visible="false">
        <telerik:RadGrid ID="RadGrid4" runat="server" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" Skin="Default">        
            <MasterTableView Dir="RTL">
                <ItemStyle BackColor="#e6ffff" Font-Names="tahoma" />
                <HeaderStyle Font-Names="tahoma" />
                <AlternatingItemStyle Font-Names="tahoma" />

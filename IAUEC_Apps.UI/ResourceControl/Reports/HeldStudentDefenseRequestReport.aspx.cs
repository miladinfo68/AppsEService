...
{
    public partial class HeldStudentDefenseRequestReport : System.Web.UI.Page
    {
        ...
        {
            var countHeld = _requestHandler.HeldStudentDefenseRequestReport(Convert.ToInt32(CollegeIddrp.SelectedValue),
            ...
            foreach (DataRow row in countHeld.Rows)
            {
                switch (row[0].ToString())
                {
                    case "1":
                        ...
                        litHumanities.Text = row[1].ToString();
                        break;
                    case "2":
                        divTechnicalEngineering.Visible = true;
                        litTechnicalEngineering.Text = row[1].ToString();
                        break;
                    case "3":
                        divManagement.Visible = true;
                        litManagement.Text = row[1].ToString();

                        break;
                    case "8":
                        divScience.Visible = true;
                        litScience.Text = row[1].ToString();
                        break;
                }
            }

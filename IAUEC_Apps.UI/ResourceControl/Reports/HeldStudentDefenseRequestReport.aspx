<%@ Page Title="" Language="C#" MasterPageFile="~/ResourceControl/MasterPages/CMSMasterResourceControl.Master" AutoEventWireup="true" CodeBehind="HeldStudentDefenseRequestReport.aspx.cs" Inherits="IAUEC_Apps.UI.ResourceControl.Reports.HeldStudentDefenseRequestReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <h3>گزارش جلسات دفاع های برگزار شده در بازه زمانی مشخص به تفکیک دانشکده
    </h3>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row" dir="rtl">
            <div class="panel panel-primary" style="margin-right: 1%; margin-left: 1%">
                <div class="panel-heading">
                    <h3 class="panel-title">جستجو جلسات دفاع برگزار شده</h3>
                </div>
        ...
        <div dir="rtl" class="row" style="margin-left: 0.01% !important; margin-right: 0.01% !important; margin-bottom: 5% !important; margin-top: 2% !important; text-align: center">
            <div class="col-md-3" runat="server" id="divHumanities" visible="False">
                <div class="alert alert-info" style="width: 96%; margin: 0 auto">
                    <h5>
                        <span>علـوم انـسانی:</span>

                        <span class="litDec">
                            <asp:Literal ID="litHumanities" runat="server">
                            </asp:Literal>
                        </span>
                    </h5>
                </div>
            ...
            <div class="col-md-3" runat="server" id="divTechnicalEngineering" visible="False">
                ...
                <div class="alert alert-info" style="width: 96%; margin: 0 auto">
                    <h5>
                        ...
                        <span class="litDec">
                            <asp:Literal ID="litTechnicalEngineering" runat="server"></asp:Literal>
                        </span>
                    </h5>
                </div>
            </div>
            <div class="col-md-3" runat="server" id="divManagement" visible="False">
                <div class="alert alert-info" style="width: 96%; margin: 0 auto">
                    <h5>
                        <span>مديريت:</span>
                        <span class="litDec">
                            <asp:Literal ID="litManagement" runat="server"></asp:Literal>
                        </span>
                    </h5>
                </div>
            </div>
            <div class="col-md-3" runat="server" id="divScience" visible="False">
                <div class="alert alert-info" style="width: 96%; margin: 0 auto">
                    <h5>
                        <span>علوم پايه و فناوري هاي نوين:</span>
                        <span class="litDec">
                            <asp:Literal ID="litScience" runat="server"></asp:Literal>
                        </span>
                    </h5>
                </div>
            </div>
                        ...
                        <telerik:RadGrid HorizontalAlign="Center" Visible="False" ID="grdResualtList" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" AllowSorting="True" AllowFilteringByColumn="True" Skin="MyCustomSkin" EnableEmbeddedSkins="false"
                            ...
                            <MasterTableView DataKeyNames="کد دانشجویی">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn AllowFiltering="true" DataField="تاریخ ثبت درخواست" HeaderText="تاریخ ثبت درخواست">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridTemplateColumn AllowFiltering="False" AllowSorting="False" HeaderText="جزئیات" UniqueName="Details">
                                        <ItemTemplate>
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <asp:Button ID="btnHistory" runat="server" OnClick="btnHistory_OnClick" Text="تاریخچه" CssClass="btn btn-primary btnPadding" Width="58" CommandArgument='<%#Eval("شماره درخواست")%>' />
                                                </div>
                                            </div>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>

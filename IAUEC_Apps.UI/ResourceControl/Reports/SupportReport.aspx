<%@ Page Title="" Language="C#" MasterPageFile="~/ResourceControl/MasterPages/CMSMasterResourceControl.Master" AutoEventWireup="true" CodeBehind="SupportReport.aspx.cs" Inherits="IAUEC_Apps.UI.ResourceControl.Reports.SupportReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <h3>گزارش وضعیت درخواست های دفاع دانشجو
    ...
    <div class="row" dir="rtl">
        <div class="panel panel-primary" style="margin-right: 1%; margin-left: 1%">
            <div class="panel-heading">
                <h3 class="panel-title">جستجو دانشجو برای نمایش وضعیت</h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-10">
                        <label style="width: 92px; text-align: left">شماره دانشجویی:</label>
                        <asp:TextBox ID="studentCodeTxt" CssClass="textBoxInput pdate disabled" runat="server">
                                
                        </asp:TextBox>
                        <%--<asp:RequiredFieldValidator ControlToValidate="studentCodeTxt" ValidationGroup="groupValidate"  runat="server" Display="Dynamic" ErrorMessage="شماره دانشجویی را وارد نمایید" ForeColor="red"></asp:RequiredFieldValidator>--%>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-5">
                        <asp:UpdatePanel ID="ButtonClick" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:Button ID="SearchBtn" runat="server" Text="جستجو" CssClass="btn btn-success btnWith" OnClick="SearchBtn_OnClick" ValidationGroup="groupValidate"></asp:Button>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
    ...
    <div class="row" dir="rtl" style="margin-left: 0.01% !important; margin-right: 0.01% !important; margin-bottom: 5% !important; margin-top: 2% !important;">
        <div class="col-md-12">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <telerik:RadGrid HorizontalAlign="Center" ID="grdDefenceList" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" AllowSorting="True" AllowFilteringByColumn="True" Skin="MyCustomSkin" EnableEmbeddedSkins="false"

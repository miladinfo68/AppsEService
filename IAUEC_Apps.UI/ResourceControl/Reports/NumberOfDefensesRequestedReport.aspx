<%@ Page Title="" Language="C#" MasterPageFile="~/ResourceControl/MasterPages/CMSMasterResourceControl.Master" AutoEventWireup="true" CodeBehind="NumberOfDefensesRequestedReport.aspx.cs" Inherits="IAUEC_Apps.UI.ResourceControl.Reports.NumberOfDefensesRequestedReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <h3>گزارش تعداد جلسات دفاع های درخواست شده در بازه زمانی مشخص به تفکیک دانشکده
    </h3>
        ...
        <div class="row" dir="rtl">
            <div class="panel panel-primary" style="margin-right: 1%; margin-left: 1%">
                <div class="panel-heading">
                    <h3 class="panel-title">جستجو تعداد جلسات دفاع درخواست شده(تاریخ جستجو تاریخ ثبت درخواست است)</h3>
                </div>
                ...
                <asp:UpdatePanel ID="UpdatePanelResualt" runat="server">
                    <ContentTemplate>
                        ...
                        <telerik:RadGrid HorizontalAlign="Center" Visible="False" ID="grdResualtList" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" AllowSorting="True" AllowFilteringByColumn="True" Skin="MyCustomSkin" EnableEmbeddedSkins="false"
                            ...
                            <MasterTableView DataKeyNames="نام دانشکده">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn AllowFiltering="true" DataField="نام دانشکده" HeaderText="دانشکده">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn AllowFiltering="true" DataField="کل درخواست ها" HeaderText="کل درخواست ها">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn AllowFiltering="true" DataField="درخواست های در حال گردش" HeaderText="در حال گردش">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn AllowFiltering="true" DataField="تایید شده در انتظار برگزاری" HeaderText="در انتظار برگزاری">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn AllowFiltering="true" DataField="برگزار شده" HeaderText="برگزار شده">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn AllowFiltering="true" DataField="درخواست های لغو شده" HeaderText="لغو شده">
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn AllowFiltering="true" DataField="درخواست های از دست رفته" HeaderText="از دست رفته">
                                    </telerik:GridBoundColumn>
                                </Columns>

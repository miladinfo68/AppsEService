...
{
    public partial class OnlinePlayDefenceReports : System.Web.UI.Page
    {
        ...
        protected void ExcleExportBtn_OnClick(object sender, EventArgs e)
        {
            ...
            var allAcceptedRequest = _requestHandler.GetListOfOnlinePlayDefenceReports(Convert.ToInt32(CollegeIddrp.SelectedValue), StartDateTxt.Text, EndDateTxt.Text, Convert.ToInt32(drpDateType.SelectedValue));
        ...
        {
            var countHeld = _requestHandler.GetOnlinePlayDefenceReports(Convert.ToInt32(CollegeIddrp.SelectedValue),
            ...
            grdResualtList.DataSource = _requestHandler.GetListOfOnlinePlayDefenceReports(Convert.ToInt32(CollegeIddrp.SelectedValue),
                  StartDateTxt.Text, EndDateTxt.Text, Convert.ToInt32(drpDateType.SelectedValue));

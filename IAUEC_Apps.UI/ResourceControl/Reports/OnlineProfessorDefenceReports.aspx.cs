...
{
    public partial class OnlineProfessorDefenceReports : System.Web.UI.Page
    {
        ...
        protected void ExcleExportBtn_OnClick(object sender, EventArgs e)
        {
            ...
            var allAcceptedRequest = _requestHandler.GetListOfOnlineProfessorDefenceReports(Convert.ToInt32(CollegeIddrp.SelectedValue), StartDateTxt.Text, EndDateTxt.Text, Convert.ToInt32(drpDateType.SelectedValue));
        ...
        {
            var countHeld = _requestHandler.GetOnlineProfessorDefenceReports(Convert.ToInt32(CollegeIddrp.SelectedValue),
            StartDateTxt.Text, EndDateTxt.Text, Convert.ToInt32(drpDateType.SelectedValue));

            foreach (DataRow row in countHeld.Rows)
            {
                switch (row[0].ToString())
                {
                    case "1":
                        divHumanities.Visible = true;
                        litHumanitiesWait.Text = row["WaitingCount"].ToString();
                        litHumanitiesHeld.Text = row["HeldCount"].ToString();
                        litHumanitiesLosed.Text = row["LosedCount"].ToString();

                        break;
                    case "2":
                        divTechnicalEngineering.Visible = true;
                        litTechnicalEngineeringWait.Text = row["WaitingCount"].ToString();
                        litTechnicalEngineeringHeld.Text = row["HeldCount"].ToString();
                        litTechnicalEngineeringLosed.Text = row["LosedCount"].ToString();
                        break;
                    case "3":
                        divManagement.Visible = true;
                        litManagementWait.Text = row["WaitingCount"].ToString();
                        litManagementHeld.Text = row["HeldCount"].ToString();
                        litManagementLosed.Text = row["LosedCount"].ToString();
                        break;
                    case "8":
                        divScience.Visible = true;
                        litScienceWait.Text = row["WaitingCount"].ToString();
                        litScienceHeld.Text = row["HeldCount"].ToString();
                        litScienceLosed.Text = row["LosedCount"].ToString();
                        break;
                }
            }


            grdResualtList.DataSource = _requestHandler.GetListOfOnlineProfessorDefenceReports(Convert.ToInt32(CollegeIddrp.SelectedValue),
                  StartDateTxt.Text, EndDateTxt.Text, Convert.ToInt32(drpDateType.SelectedValue));

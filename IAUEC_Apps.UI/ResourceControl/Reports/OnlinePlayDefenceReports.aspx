<%@ Page Title="" Language="C#" MasterPageFile="~/ResourceControl/MasterPages/CMSMasterResourceControl.Master" AutoEventWireup="true" CodeBehind="OnlinePlayDefenceReports.aspx.cs" Inherits="IAUEC_Apps.UI.ResourceControl.Reports.OnlinePlayDefenceReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <h3>گزارش جلسات دفاع های پخش آنلاین در بازه زمانی مشخص به تفکیک دانشکده
    </h3>
        ...
        <div class="row" dir="rtl">
            <div class="panel panel-primary" style="margin-right: 1%; margin-left: 1%">
                <div class="panel-heading">
                    <h3 class="panel-title">جستجو تعداد جلسات پخش آنلاین</h3>
                </div>
                        ...
                        <telerik:RadGrid HorizontalAlign="Center" Visible="False" ID="grdResualtList" runat="server" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" AllowSorting="True" AllowFilteringByColumn="True" Skin="MyCustomSkin" EnableEmbeddedSkins="false"
                            ...
                            <MasterTableView DataKeyNames="کد دانشجویی">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn AllowFiltering="true" DataField="نام و نام خانوادگی" HeaderText="نام و نام خانوادگی" HeaderStyle-Width="150px">
                                    </telerik:GridBoundColumn>

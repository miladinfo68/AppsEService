...
{
    public partial class AcceptedDefenseMeetingFromOfficeReports : System.Web.UI.Page
    {
        ...
        protected void ExcleExportBtn_OnClick(object sender, EventArgs e)
        {
            ...
            var allAcceptedRequest = _requestHandler.GetDefenceAcceptInformationReports(Convert.ToInt32(CollegeIddrp.SelectedValue), StartDateTxt.Text, EndDateTxt.Text, Convert.ToInt32(drpDateType.SelectedValue));
            //var allAcceptedRequest = _requestHandler.GetAllAccepetedDefenceRequests(Convert.ToInt32(CollegeIddrp.SelectedValue));
            //////////
        ...
        {
            grdResualtList.DataSource = _requestHandler.GetDefenceAcceptInformationReports(Convert.ToInt32(CollegeIddrp.SelectedValue),

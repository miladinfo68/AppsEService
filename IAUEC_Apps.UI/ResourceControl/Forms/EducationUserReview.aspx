<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ResourceControl/MasterPages/CMSMasterResourceControl.Master" CodeBehind="EducationUserReview.aspx.cs" Inherits="ResourceControl.PL.Forms.EducationUser" %>
                                ...
                                <asp:GridView ID="grdListOfRequest" runat="server" AllowPaging="true" OnPageIndexChanging="grdListOfRequest_PageIndexChanging" CssClass="table table-bordered text-center table-condensed table-striped" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="هیچ درخواستی پیدا نشد." OnRowCommand="grdListOfRequest_RowCommand" OnRowDataBound="grdListOfRequest_RowDataBound" OnRowDeleting="grdListOfRequest_RowDeleting">
                                    ...
                                    <Columns>
                                        ...
                                        <%--<asp:TemplateField HeaderText="عملیات">
                                            <ItemTemplate>
                                                <asp:Button ID="btnCheckRequest" Text="بررسی" runat="server" CssClass="btn btn-sm btn-primary btn-block" CommandName="checkReq" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ID") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                        <asp:TemplateField HeaderText="بررسی">
                                            <ItemTemplate>
                                                <asp:Button ID="btnEditRequest" Text="بررسی" runat="server" CssClass="btn btn-sm btn-danger btn-block" CommandName="edit" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ID") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="اطلاع رسانی" Visible="false">
                                            <ItemTemplate>
                                                <asp:Button ID="btnInform" Text="اطلاع رسانی" runat="server" CssClass="btn btn-sm btn-info btn-block" CommandName="info" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ID") %>' OnClientClick="confirmAspButton(this); return false;" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="حذف درخواست" Visible="false">
                                            <ItemTemplate>
                                                <asp:Button ID="btnDeleteRequest" Text="حذف" runat="server" CssClass="btn btn-danger btn-block" CommandName="delete" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ID") %>' OnClientClick="confirmAspButton(this); return false;" />
                                            </ItemTemplate>
                                        </asp:TemplateField>

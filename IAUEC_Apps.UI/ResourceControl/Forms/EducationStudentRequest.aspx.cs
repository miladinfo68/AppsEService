...
{
    public partial class EducationStudentRequest : System.Web.UI.Page
    {
            ...
            private void GridBindForAdmin(int roleId, int state)
        {
            ...
            if (requestHandler.GetRequestListBystatusForAdmin(state) != null)
                grdListOfRequest.DataSource = requestHandler.GetRequestListBystatusForAdmin(state).Where(x => x.Subject == "StudentDefence" ).ToList();
            else
        ...
        protected void grdListOfRequest_RowCommand(object sender, GridViewCommandEventArgs e)
        {
          ...
          //  if (e.CommandName == "edit")
          //   {
          //    Response.Redirect("StudentEditRequest.aspx?id=" + generaterandomstr() + "@A" + "0" + "-" + generaterandomstr() + "&reqId=" + e.CommandArgument);
          //StudentEditRequest
         //   }
        ...
        protected void btnLoanDocsGrid_Click(object sender, EventArgs e)
        {
            GridBind(Convert.ToInt32(drpRequestTypeList.SelectedValue));
        }

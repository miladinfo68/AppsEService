<%@ Page Title="" Language="C#" MasterPageFile="~/ResourceControl/MasterPages/CMSMasterResourceControl.Master" AutoEventWireup="true" CodeBehind="EducationAvoidDate.aspx.cs" Inherits="IAUEC_Apps.UI.ResourceControl.Forms.EducationAvoidDate" %>
        ...
        <div class="modal-dialog" role="document" style="width:90%;">
            <div class="modal-content" style="width:90%;" >
                <div class="modal-header">
                    <h5 class="modal-title">ویرایش بستن تاریخ ثبت درخواست دفاع</h5>
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    ...
                                    <div class="row" style="margin-top: 13px">
                                        ...
                                        <div class="col-md-10">
                                            <span style="float:right;margin-bottom:2px">علـت بستن تاریخ درخواست </span>
            ...
            <div class="panel-group">
                <div class="panel panel panel-primary">
                    <div class="bg-blue-sky">
                        ...
                        <h5 class="header-inline-display" style="font-family: 'B Titr'">بستن تاریخ ثبت درخواست دفاع</h5>
                    </div>
                    <div class="list-group-item" style="background: #a4935312; ">
                        ...
                        <div class="row" style="margin-top: 13px">
                            ...
                            <div class="col-md-10">
                                <span style="">علـت بستن تاریخ درخواست </span>
                        ...
                        <div class="row">
                             <asp:Button ID="btnSave" runat="server" Text="ثبت"  Width="120px" Height="32px" OnClick="btnSave_Click" class="btn btn-success" Style="float: left;margin-left:5%" ValidationGroup="register"/>
                        </div>
                                   
                        <div class="row" dir="rtl" style="margin-right: 1%; margin-left: 1%;margin-top:1%">


                            <telerik:RadGrid ID="grdAvoidDate" runat="server" AutoGenerateColumns="False"
                                BackColor="#ffcccc"
                                PageSize="20"
                                ...
                                AllowPaging="True"
                                OnNeedDataSource="grdAvoidDate_NeedDataSource"
                                ...
                                <MasterTableView DataKeyNames="Id" NoMasterRecordsText="رکوردی برای این جدول وجود ندارد" Dir="RTL">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn AllowFiltering="false" FilterControlWidth="70px" DataField="description" HeaderText="توضیحات بستن">
                                        </telerik:GridBoundColumn>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ResourceControl/MasterPages/CMSMasterResourceControl.Master" CodeBehind="OfficeUserReview.aspx.cs" Inherits="ResourceControl.PL.Forms.OfficeUserReview" %>
    ...
    <telerik:RadWindow ID="RadWindow1" AutoSize="false" Height="600" runat="server" Width="1050" Modal="True">
        <ContentTemplate>
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    <div runat="server" id="dvOperation1" class="alert alert-danger" role="alert" style="text-align: center; width: 95%; margin: auto; margin-top: 1%; font-size: x-large;">به منظور ثبت نهایی می بایست برای تمام ساعات و تاریخ ها یک کلاس انتخاب نمایید</div>
                    <br />
                    <div class="panel panel-primary" style="text-align: right; direction: rtl; width: 95%; margin: auto;">
                        ...
                        <div class="panel-body" style="margin: auto;">
                            ...
                            <div class="panel panel-default" style="text-align: right; direction: rtl; width: 50%; margin: auto; float: right; margin-left: 3%; text-align: center;">
                                <div class="panel-heading bg-green">نام درس</div>
                                <div class="panel-body">
    ...
    <script type="text/javascript">
        ...
        $("body").on("click", "#<%=btnSubmitFinal.ClientID%>", function () {
            ...
            if (IsValid) {
                ...
                $.ajax({
                    type: "POST",
                    url: "OfficeUserReview.aspx/btnSubmitFinalClick",

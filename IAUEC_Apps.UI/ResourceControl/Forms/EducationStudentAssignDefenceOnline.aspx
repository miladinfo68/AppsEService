<%@ Page Title="" Language="C#" MasterPageFile="~/ResourceControl/MasterPages/CMSMasterResourceControl.Master" AutoEventWireup="true" CodeBehind="EducationStudentAssignDefenceOnline.aspx.cs" Inherits="IAUEC_Apps.UI.ResourceControl.Forms.EducationStudentAssignDefenceOnline" %>
            ...
            <div class="row" dir="rtl" style="margin-right: 1%; margin-bottom: 2%">
                <div class="form-inline">
                    <div class="form-group">
                        ...
                        <label>نـوع دفـاع:</label>
                        <asp:DropDownList ID="drpTypeDefence" runat="server" CssClass="form-control" AutoPostBack="True" ForeColor="Black">
                        </asp:DropDownList>
            ...
            <div class="panel-group">
                <div class="panel panel panel-primary">
                    ...
                    <div class="list-group-item">
                        ...
                        <h5 class="header-inline-display">مشاهده دانشجویان مجاز برای دفاع آنلاین:</h5>
                            ...
                            <div class="tab-content col-md-12">
                                ...
                                <telerik:GridBoundColumn AllowFiltering="true" DataField="Dsc" HeaderText="نوع دفاع">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="آیدی" HeaderStyle-VerticalAlign="Middle" Visible="false" AllowFiltering="false">
                                                        ...
                                                        <telerik:GridTemplateColumn AllowFiltering="false" HeaderText="هزینه دفاع" HeaderStyle-VerticalAlign="Middle">

                                                            <ItemTemplate>
                                                                <asp:Label ID="lblmoney" runat="server"
                                                                    Text='<%#int.Parse(Eval("money").ToString()).ToString("#,###")+" "+(Eval("currency").ToString())%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </telerik:GridTemplateColumn>

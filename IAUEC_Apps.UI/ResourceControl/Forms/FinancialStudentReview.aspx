<%@ Page Title="" Language="C#" MasterPageFile="~/ResourceControl/MasterPages/CMSMasterResourceControl.Master" AutoEventWireup="true" CodeBehind="FinancialStudentReview.aspx.cs" Inherits="IAUEC_Apps.UI.ResourceControl.Forms.FinancialStudentReview" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderplaceHolder" runat="server">
 ...
 <telerik:RadScriptBlock runat="server">
        <script type="text/javascript">
            ...
            function closeRadWindowConfirmSendSmspopup() {

                var window = $find('<%=rdwSendSms.ClientID %>');
                window.close();
...
حداکثر تا 48 ساعت قبل از  شروع دفاع زمان برای تایید یا لغو دفاع‌ها وجود دارد بعد از این زمان دفاع به صورت اتوماتیک لغو خواهد شد
            </p>
</div>--%>
    ...
    <div class="row" dir="rtl" style="margin-top: 2%">
        <div class="col-md-3" style="margin-right: 2%;">
            <asp:DropDownList ID="drpRequestTypeList" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="drpRequestTypeList_OnSelectedIndexChanged">
                ...
                <asp:ListItem Text="لیست درخواستهای ازدست رفته " Value="4" />
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Always" ChildrenAsTriggers="true">
                <ContentTemplate>
                    ...
                    <asp:HiddenField ID="hdnfDenyReqId" runat="server" />
                     <asp:HiddenField ID="hdnfDenyStcode" runat="server"></asp:HiddenField>  
                </ContentTemplate>
            </asp:UpdatePanel>
        </ContentTemplate>
    </telerik:RadWindow>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6" runat="server" id="divApprove">
                                                ...
                                                <asp:Button ID="btnApprove" Width="65" runat="server" CommandName="Confirm" CommandArgument='<%#Eval("ID")+"-"+Eval("StudentCode")+"-"+Eval("RequestDate") %>' ToolTip="تایید" Text="تایید" CssClass="btn btn-primary" />
                                                </div>
                                        <div class="col-md-6" runat="server" id="divAvoid" visible="true">
                                          ...
                                          <div class="col-md-6" runat="server" id="divSendSms" >
                                                <asp:Button ID="btnSendSms" Width="65" CommandName="SendSms" runat="server" OnClick="btnSendSms_Click" ToolTip="ارسال پیامک" Text='<%#(bool.Parse(Eval("IsSendSmsFinancial").ToString()) == true ?"نمایش پیامک":"ارسال پیامک")%>' CssClass="btn btn-danger" CommandArgument='<%#Eval("ID")+"-"+Eval("StudentCode")+"-"+Eval("RequestDate") +"-"+(bool.Parse(Eval("IsSendSmsFinancial").ToString())==true?"true":"false").ToString()+"-"+Eval("MsgSendSmsFinancial")%>'  />
    ...
    <telerik:RadWindow ID="rdwSendSms" Height="400" Width="600" AutoSizeBehaviors="HeightProportional" runat="server">
        <ContentTemplate>
            <asp:UpdatePanel ID="UpdatePanelSendSms" runat="server" UpdateMode="Always" ChildrenAsTriggers="true">
                <ContentTemplate>
                       <div class="container" dir="rtl" style="padding: 10px">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="alert alert-danger" style="text-align: center">آیا مطمئن از ارسال پیامک هستید؟ </h4>
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h6 class="alert alert-info" >متن زیر جهت اطلاع برای دانشجو ارسال می گردد.</h6>
                                <h5 id="lblSendSms">متن پیامک:</h5>
                                <asp:TextBox ID="txtSendSms" TextMode="MultiLine" CssClass="form-control " runat="server" />


                                <asp:Label ID="lblSendSmsValidate" Visible="False" ForeColor="red" runat="server" Text="لطفا متن پیامک  را ذکر کنید"></asp:Label>
                           ...
                           <div class="row" style="padding-top:10px"> 
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <asp:Button ID="btnApproveSendSms" Text="ارسال پیامک"  OnClientClick="validateDenyField()" OnClick="btnApproveSendSms_Click" CssClass="btn btn-success" ValidationGroup="Deny" runat="server" Style="width: 100%;" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:Button ID="btnCancleSendSms" Text="لغــو" OnClick="btnCancleSendSms_Click" CssClass="btn btn-default" runat="server" Style="width: 100%;" />
                                </div>
                            </div>
                        </div>

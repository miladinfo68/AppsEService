...
{
    public partial class ReportAcceptRequest : System.Web.UI.Page
    {
        ...
        protected void grd_Show_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            ...
            grd_Show.DataSource = FRB.GetRequestAccept();
        ...
        protected void btn_excel_Click(object sender, EventArgs e)
        {
            ...
            grd_Show.ExportSettings.FileName = "گزارش درخواست های تایید شده";
        ...
        protected void grd_Show_ExcelMLWorkBookCreated(object sender, GridExcelMLWorkBookCreatedEventArgs e)
        {
            int r = 0;

...
{
    public partial class ReportEditingRequest : System.Web.UI.Page
    {
        ...
        {
            grd_Show.DataSource = FRB.GetRequestEditing();
            PersiaFiltering();
        }
        ...
        protected void grd_Show_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            if (e.CommandName == "Detail")
            {
                ...
                Response.Redirect("ShowDetailInfo.aspx?ID=" + dtProf.Rows[0]["ID"].ToString());

...
{
    public partial class ReportRequestPending : System.Web.UI.Page
    {
        ...
        { 
        grd_Show.DataSource = FRB.GetRequestPending();
            PersiaFiltering();
        }
        ...
        {         
            ...
            //    if (Convert.ToInt32(((DataRowView)item.DataItem)["Status"]) == 5)
            //    {
            //        e.Item.BackColor = Color.Bisque;
            //    }
            //    if (Convert.ToInt32(((DataRowView)item.DataItem)["Status"]) == 6)
            //    {
        ...
        protected void grd_Show_ItemCommand(object sender, GridCommandEventArgs e)
        {

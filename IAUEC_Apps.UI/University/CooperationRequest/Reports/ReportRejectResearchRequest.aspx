<%@ Page Language="C#" MasterPageFile="~/University/CooperationRequest/MasterPages/Cooperation.Master" AutoEventWireup="true" CodeBehind="ReportRejectResearchRequest.aspx.cs" Inherits="IAUEC_Apps.UI.University.CooperationRequest.Reports.ReportRejectResearchRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <h3 style="color: blue">گزارش درخواست های رد شده توسط واحد پژوهش
    </h3>
</asp:Content>
        ...
        <telerik:RadGrid ID="grd_Show" runat="server" PageSize="50" BorderWidth="10px"
            ...
            <MasterTableView DataKeyNames="ID">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="date" HeaderText="تاریخ رد درخواست توسط پژوهش" AllowFiltering="false">
                    </telerik:GridBoundColumn>

<%@ Page Language="C#"  MasterPageFile="~/University/CooperationRequest/MasterPages/Cooperation.Master" AutoEventWireup="true" CodeBehind="ReportResearchRequestPending.aspx.cs" Inherits="IAUEC_Apps.UI.University.CooperationRequest.Reports.ReportResearchRequestPending" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <h3 style="color: blue">گزارش درخواست های در حال بررسی توسط واحد پژوهش
    </h3>
</asp:Content>
        ...
        <telerik:RadGrid ID="grd_Show" runat="server" PageSize="50" BorderWidth="10px"
            ...
            <MasterTableView DataKeyNames="ID">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idd_meli" HeaderText="کد ملی" AllowFiltering="true" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="namep" HeaderText="نام پدر" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="mobile" HeaderText="موبایل" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="add_email" HeaderText="پست الکترونیکی" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                    </telerik:GridBoundColumn>

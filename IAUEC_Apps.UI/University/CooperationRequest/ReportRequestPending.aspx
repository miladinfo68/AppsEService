<%@ Page Title="" Language="C#" MasterPageFile="~/University/CooperationRequest/MasterPages/Cooperation.Master" AutoEventWireup="true" CodeBehind="ReportRequestPending.aspx.cs" Inherits="IAUEC_Apps.UI.University.CooperationRequest.Reports.ReportRequestPending" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <h3 style="color: blue">گزارش درخواست های در حال بررسی توسط کارگزینی
    </h3>
</asp:Content>

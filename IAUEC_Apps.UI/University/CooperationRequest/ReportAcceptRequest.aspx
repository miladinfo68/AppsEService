<%@ Page Title="" Language="C#" MasterPageFile="~/University/CooperationRequest/MasterPages/Cooperation.Master" AutoEventWireup="true" CodeBehind="ReportAcceptRequest.aspx.cs" Inherits="IAUEC_Apps.UI.University.CooperationRequest.Reports.ReportAcceptRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <h3 style="color: #007E33">گزارش درخواست های پذیرفته شده توسط کارگزینی
    </h3>
</asp:Content>
        ...
        <telerik:RadGrid ID="grd_Show" runat="server" PageSize="50" BorderWidth="10px"
            ...
            <MasterTableView DataKeyNames="ID">
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="Cooperation" HeaderText="نوع درخواست همکاری"  Exportable="true" Display="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="SidaCode" HeaderText="کد استاد در سیدا" Visible="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="portalCode" HeaderText="کد استاد در پرتال" Exportable="true" Display="true">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="name" HeaderText="نام" AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="martabeh1" HeaderText="مرتبه" AllowFiltering="false">
                    </telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn DataField="date" HeaderText="تاریخ تایید درخواست" AllowFiltering="true" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                    </telerik:GridBoundColumn>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Contract_DeputyGroup.ascx.cs" Inherits="IAUEC_Apps.UI.University.CooperationRequest.UserControls.Contract_DeputyGroup" %>
    ...
    <div class="contractPages">
        ...
        <div class="content-block">
            <div class="pageWrapper">
                <h6 class="topTitle">قرار داد معاون گروه آموزشی</h6>
                <p>
                    ...
                    <span style="font-weight: bold">معاون گروه </span>
                    <span>نامیده می شود از طرف دیگر به شرح ذیل منقعد گردید و طرفین ملزم به اجرای مفاد آن می باشند.</span>
                </p>
                <p>
                    <span class="boldFont divBlock dynamicContent">ماده 1- مشخصات معاون گروه:</span>
                    <span>نام: </span>
                ...
                <div class="lp1">
                    <p>
                        ...
                        <br />
                        <span>تبصره1- معاونان گروه بازنشسته و یا آن دسته از معاون گروه هایی که به هر عنوان بیمه آنها به صورت کامل از محل دیگری پرداخت می گردد از این کسورات معاف می باشند.</span>
                    </p>
                </div>
            </div>
            <div class="pageWrapper">
                <div class="fp2"></div>
                <p>
                    <span class="boldFont divBlock">ماده 5- تعهدات معاون گروه:</span>
                    <br />
                    <span>5-1- معاون گروه متعهد می گردد خدمات موضوع این قرارداد را عینا مطابق ماده 2 بدون تاخیر و بر طبق برنامه داده شده زیر نظر رئیس دانشگاه و وفق بخشنامه شماره 10/556 سازمان مرکزی دانشگاه به انجام برساند.</span>
                    <br />
                    <span>5-2- در صورتی که در اثنای قرارداد واحد متوجه بیان غیر واقعی در اظهارات معاونگروه شود، واحد می تواند قرارداد را یک طرفه فسخ و تمام زیان حاصله را از معاون گروه وصول نماید.</span>
                    <br />
                    <span>5-3- جهت تعامل بیشتر با دانشجویان و دانشکده مربوطه، معاون گروه موظف به حضور فیزیکی هر هفته به مدت 10 ساعت و 2 ساعت به صورت آنلاین می باشد.</span>
                    <br />
                    <span>تبصره 2- منظور از ساعت حضور، ساعت خارج از زمان برگزاری کلاس های تدریس توسط معاون گروه می باشد.</span>
                    <br />
                    <span>5-4- در صورتی که ارائه خدمات موضوع قرارداد به تشخیص دانشگاه از جهت خصوصیات و کیفیت مطلوب و یا برابر مقررات و ضوابط آموزش و پژوهشی واحد نباشد، معاون گروه حقی بر دریافت حق الزحمه مقرر نخواهد داشت.</span>
                    <br />
                    <span>5-5- در صورت عدم اجرای تعهدات توسط معاون گروه، دانشگاه می تواند قرارداد را یک طرفه فسخ نماید و معاون گروه حق هر نوع اعتراض و ادعایی را از خود سلب نمود.</span>
                    <br />

                    <span>5-6- معاون گروه متعهد به رعایت شئونات شغلی، اخلاقی و دینی در طول مدت همکاری با دانشگاه می باشد.</span>
                    <br />
                    ...
                    <br />
                    <span>5-8- معاون گروه نمی تواند تحت هیچ عنوان، حتی در زمان بروز اختلاف، تعهدات خویش را انجام ندهد یا تعلیق نماید. در غیر این سورت معادل دو برابر کل قرارداد به عنوان جریمه عدم انجام تعهد، کسر خواهد شد.</span>
                </p>
                <p>
                    <span class="boldFont divBlock">ماده 6- تعهدات واحد:</span>
                    <br />
                    <span>دانشگاه منعهد می گردد به پرداخت کامل حق الزحمه برابر مبلغ توافق شده به معاون گروه پس از طی مراحل اداری و ایفای کامل تعهدات قراردادی می باشد.</span>
                </p>
                <p>
            ...
            <div class="pageWrapper">
                ...
                <div class="lp2">
                    <p>
                        ...
                        <br />
                        <span>این قرارداد از جانب معاون گروه لازم و از جانب دانشگاه جایز خواهد بود، لذا دانشگاه هر زمان که بخواهد می تواند قرارداد را فسخ نماید.</span>
                    </p>
                </div>
                <div class="fp3"></div>
            ...
            <div class="pageWrapper">
                <p>
                    ...
                    <br />
                    <span>اقامتگاه قانونی طرفین همان است که در صدر این قرارداد ذکر شده و کلیه ابلاغیه ها، اخطاریه ها و مکاتباتی که توسط دانشگاه به اقامتگاه اعلامی یا آدرس پست الکترونیکی)ایمیل( اعلامی از سوی معاون گروه ارسال می گردد در حکم ابلاغ قانونی محسوب می گردد.
                        ضمنا معاون گروه موظف است هرگونه  تغییر اقامتگاه خود را فورا و کتبا حداکثر ظرف مدت 7/هفت روز به اطلاع دانشگاه برساند. در غیر این صورت کلی مکاتبات ارسالی به نشانی های مذکور در این قرارداد ابلاغ شده و قانونی می باشد. </span>

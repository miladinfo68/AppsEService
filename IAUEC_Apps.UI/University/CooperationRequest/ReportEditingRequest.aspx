<%@ Page Title="" Language="C#" MasterPageFile="~/University/CooperationRequest/MasterPages/Cooperation.Master" AutoEventWireup="true" CodeBehind="ReportEditingRequest.aspx.cs" Inherits="IAUEC_Apps.UI.University.CooperationRequest.ReportEditingRequest" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeaderplaceHolder" runat="server">
    <title>گزارش های اساتید در حال ویرایش </title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageTitle" runat="server">
    <h3 style="color: blue">گزارش های  در حال ویرایش 
    </h3>
</asp:Content>
        ...
        <telerik:RadGrid ID="grd_Show" runat="server" PageSize="50" BorderWidth="10px"
            ...
            <MasterTableView DataKeyNames="ID">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idd_meli" HeaderText="کدملی" AllowFiltering="true" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                    ...
                    <telerik:GridTemplateColumn AllowFiltering="False" HeaderText="نمایش" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Bold="true">
                            <ItemTemplate>
                                <asp:Button ID="btn_Detail" Text="مشاهده جزئیات" runat="server" CommandName="Detail" CommandArgument='<%#Eval("id")+","+Eval("name")+","+Eval("family")+","+Eval("mobile")+","+Eval("status")+ ","+Eval("mobile") %>' CssClass="btn btn-success" Width="100px" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                </Columns>
            </MasterTableView>

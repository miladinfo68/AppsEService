<%@ Page Title="" Language="C#" MasterPageFile="~/University/CooperationRequest/MasterPages/Cooperation.Master" AutoEventWireup="true" CodeBehind="ShowDetailInfo.aspx.cs" Inherits="IAUEC_Apps.UI.University.CooperationRequest.Reports.ShowDetailInfo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#persInfo input,#persInfo select,#persInfo textarea").attr("disabled", "disabled");
            $('#persInfo input[type="submit"]').removeAttr("disabled");
        });
        //
        //
    ...
    <div>
        <div class="">
            ...
            <div style="direction: rtl" id="persInfo">
                    ...
                    <div class="panel-body well">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" ErrorMessage="کد ملی خود را وارد نمایید" ForeColor="Red" ValidationGroup="info" Text="*" ControlToValidate="txtCodeMeli" runat="server" />--%>
                                        <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ValidationExpression="^([\d]10)$" ControlToValidate="txtCodeMeli" ForeColor="Red" Text="*" ValidationGroup="info" ErrorMessage="فقط 10 رقم کد ملی را بدون فاصله و یا خط تیره وارد کنید"></asp:RegularExpressionValidator>--%>
                            ...
                            <div class="col-md-4">
                                ...
                                <%--                                <div class="row">
                                    <div class="col-md-7">
                                        <asp:Label ID="Label26" Text="جنسیت" runat="server" />
                                        <asp:RadioButtonList ID="rblGender" runat="server" RepeatDirection="Horizontal" CssClass="radio">
                                            <asp:ListItem Text="مرد" Value="1" />
                                            <asp:ListItem Text="زن" Value="2" />
                                        </asp:RadioButtonList>
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <asp:Label ID="Label26" Text="نوع دانشگاه محل اخذ آخرین مدرک تحصیلی" runat="server" Width="280px" />
                        ...
                        <div class="panel-body well">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <asp:Label ID="Label22" Text="نام دانشگاه محل خدمت" runat="server" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <asp:Label ID="Label43" Text="نوع دانشگاه محل خدمت" runat="server" />
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            <asp:Label ID="Label44" Text="مبلغ حکم" runat="server" />
                                            <asp:TextBox ID="txtHokmAmount" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <asp:CheckBox ID="chkBoundHour" runat="server" Text="متقاضی تکمیل ساعت موظفی در واحد الکترونیکی هستم" CssClass="checkbox" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="col-md-10">
                ...
                <div id="Div1" class="panel panel-danger" runat="server" visible="false">
                    ...
                    <div class="panel-body well">
                        <div class="row">
                            <telerik:RadListView runat="server" ID="rlv" OnItemDataBound="rlv_ItemDataBound1" OnItemCommand="rlv_ItemCommand1">
                                <ItemTemplate>
    ...
    <div class="panel panel-warning" style="background-color: azure">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="col-md-4">
                    <%--<asp:Button ID="btn_ChangeInfo" runat="server" Text="ثبت تغییراطلاعات" CssClass="btn btn-warning" OnClick="btn_ChangeInfo_Click" ValidationGroup="info" />--%>
                ...
                <div class="col-md-1">
                    <%--<asp:Button ID="btn_Taeed" Text="تأیید" runat="server" CssClass="btn btn-success" Width="50px" OnClick="btn_Taeed_Click" Visible="false"/>--%>
                </div>
                <div class="col-md-1">
                    <%--<asp:Button ID="btn_Rad" Text="رد" runat="server" CssClass="btn btn-danger" Width="50px" OnClick="btn_Rad_Click"/>--%>
                </div>
                <div class="col-md-1">
                    <asp:Button ID="Button1" Text="بستن" runat="server" CssClass="btn btn-primary" OnClick="Button1_Click" />
                </div>
            </div>
        </div>
    </div>

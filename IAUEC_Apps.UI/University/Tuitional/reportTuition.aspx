<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/University/Tuitional/masterPages/tuitionalMasterpage.Master" CodeBehind="reportTuition.aspx.cs" Inherits="IAUEC_Apps.UI.University.Tuitional.reportTuition" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" dir="rtl" style="padding: 20px">
        ...
        <div class="row" style="background-color: lightgoldenrodyellow">
            <div class="col-md-12">
                ...
                <ul style="color: rebeccapurple; text-align: justify">
                    <li>
                        <span>لطفا ابتدا نسبت به بارگذاری فایل اکسل مورد نظر اقدام فرمایید و سپس دکمه</span><span class="btn btn-warning btn-sm">  بررسی فایل</span><span>  را فشار دهید.</span>
                    </li>
                    <li>
                    ...
                    <li>
                        <span>پس از انتخاب تمام موارد مورد نیاز، دکمه </span><span class="btn btn-success btn-sm">آپدیت اکسل</span><span>  را فشار دهید</span>
                    </li>
                    <li>
                    ...
                    <li>
                        <span>پس از پایان عملیات، فایل اکسل جدید برای شما دانلود خواهد شد.</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <asp:Button ID="btnUpdateExcel" CssClass="btn btn-success left_col" Visible="false" runat="server" Text="آپدیت اکسل" OnClick="btnUpdateExcel_Click" />

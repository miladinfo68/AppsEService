<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchOfStudent.aspx.cs" Inherits="IAUEC_Apps.UI.University.Education.CMS.SearchOfStudent" %>
        ...
        <div class="row" style="direction:rtl">
            ...
            <div class="col-md-2">
                ...
                <div class="col-md-2">
                   <asp:UpdatePanel ID="UP2" runat="server" >
                    ...
                    <%--<asp:TextBox ID="txt_StatusStu" runat="server"></asp:TextBox>--%>
                </div>           
            </div>
          ...
          <div class="col-md-3"></div>
            ...
            <div class="col-md-2">
                ...
                <%--<asp:TextBox ID="txt_Field" runat="server"></asp:TextBox>--%>
            </div>
              <div class="col-md-1">
              </div>
         <div class="col-md-2">

<%@ Page Title="" Language="C#" MasterPageFile="~/University/Exam/MasterPages/CMSExamMaster.Master" AutoEventWireup="true" CodeBehind="classlistUI.aspx.cs" Inherits="IAUEC_Apps.UI.University.Exam.CMS.classlistUI" %>
                  ...
                  <telerik:RadGrid ID="grd_Class" runat="server" AllowPaging="true" PageSize="50" OnItemDataBound="grd_Class_ItemDataBound" OnItemCommand="grd_Class_ItemCommand" 
                    ...
                    <MasterTableView DataKeyNames="coursecode">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="coursecode" HeaderText="شناسه کلاس" AllowFiltering="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="classCode" HeaderText="کد کلاس" Visible="false">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="Name_City" HeaderText="نام شهر" AllowFiltering="false">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridTemplateColumn AllowFiltering="false">
                                ...
                                <ItemTemplate>
                                    <asp:Button ID="btn_Taeid" runat="server"  Enabled="true" CommandArgument='<%#Eval("coursecode")+","+ Eval("Zarfiat") +","+ Eval("cityId") +","+ Eval("classCode") %>' CommandName="bookinglist" CssClass="btn btn-success"  Text="تعیین" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn AllowFiltering="false">
                                ...
                                <ItemStyle HorizontalAlign="Right" />
                                <ItemTemplate>
                                    <asp:Button ID="btn_Chair" runat="server"   CommandArgument='<%#Eval("coursecode")+","+ Eval("Zarfiat") + "," + Eval("cityId") +","+ Eval("classCode") %>' CommandName="SeatSpecify" CssClass="btn btn-info"  Text="تخصیص صندلی" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                        </Columns>
                    </MasterTableView>

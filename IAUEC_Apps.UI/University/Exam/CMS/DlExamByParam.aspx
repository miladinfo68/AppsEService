<%@ Page Title="" Language="C#" MasterPageFile="~/University/Exam/MasterPages/CMSExamMaster.Master" AutoEventWireup="true" CodeBehind="DlExamByParam.aspx.cs" Inherits="IAUEC_Apps.UI.University.Exam.CMS.DlExamByParam" %>
            ...
            <telerik:RadGrid ID="grd_CourseList" runat="server" AutoGenerateColumns="false" OnItemCommand="grd_CourseList_ItemCommand" OnItemDataBound="grd_CourseList_ItemDataBound" EnableEmbeddedSkins="False" Skin="MyCustomSkin">
                <MasterTableView>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="وضعیت پاسخنامه">
                            <ItemTemplate>
                                <asp:Button ID="btn_printExamSheet" runat="server" CommandName="ExamSheet" Text="پرینت پاسخنامه" Visible="false" CommandArgument='<%#Eval("did") +","+ Eval("cityId").ToString()+","+ Eval("q1Status").ToString()+","+ Eval("q2Status").ToString()%>' CssClass="btn btn-info" />
                                <asp:Button ID="btn_chk" runat="server" CommandName="testexam" Text="پرینت پاسخنامه تستی" Visible="false" CommandArgument='<%#Eval("did") +","+ Eval("cityId").ToString()+","+ Eval("q1Status").ToString()+","+ Eval("q2Status").ToString()%>' CssClass="btn btn-warning" />
                                <asp:Label runat="server" ID="lblNoAnswerSheet" Text="پاسخنامه ندارد" Visible="false"></asp:Label>
                                <asp:Label runat="server" ID="lblAnswerSheet" Text="پاسخنامه دارد" Visible="false"></asp:Label>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>

                        <telerik:GridBoundColumn AllowFiltering="false" DataField="cityId" HeaderText="شناسه شهر" Visible="false">
                        </telerik:GridBoundColumn>

                        <telerik:GridBoundColumn AllowFiltering="false" DataField="q2Status" HeaderText="وضعیت سوال دوم" Visible="false">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn>
                            ...
                            <ItemTemplate>
                                ...
                                <span class="passwordText">
                                    <asp:TextBox runat="server" CssClass="copyText" ID="lbl_Password" ReadOnly="true"></asp:TextBox>
                                </span>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>

<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="classrangelistUI.aspx.cs" Inherits="IAUEC_Apps.UI.University.Exam.CMS.TestForms.classrangelistUI" %>
             ...
             <div class="container-fluid" id="div1" dir="rtl" style="border: 1px solid rgba(170, 102, 204,0.7);border-radius:5px; margin-bottom:1%;padding:1%;color:#000">
               ...
               <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-2"><asp:DropDownList runat="server" ID="ddl_ClassNumber" CssClass="form-control input-sm" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AutoPostBack="True" Width="100px" ForeColor="Black">
                    ...
                    <div class="col-md-1">  <%--<asp:Button ID="btn_takhsis" runat="server" OnClick="Button3_Click" Text="تخصیص صندلی" CssClass="btn btn-success" Visible="false" />--%>
                </div>
                    <div class="col-md-1"><asp:Button ID="btn_sabt" runat="server"  CssClass="btn btn-exam" OnClick="Button2_Click" Text="ثبت"  /></div>

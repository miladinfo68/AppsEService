<%@ Page Title="" Language="C#" MasterPageFile="~/University/Request/MasterPages/CMSRequestMaster.Master" AutoEventWireup="true" CodeBehind="StCardPaymentReport.aspx.cs" Inherits="IAUEC_Apps.UI.University.Request.CMS.StCardPaymentReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ImageButton ID="img_ExportToExcel" runat="server" ImageUrl="~/University/Theme/images/Excel_ExcelML.png"
      ...
      <telerik:RadGrid ID="grd_PayReport"  Skin="MyCustomSkin" runat="server" FilterItemStyle-Height="23px" AllowPaging="true" PageSize="20" AllowFilteringByColumn="True"  AutoGenerateColumns="False"  OnNeedDataSource="grd_PayReport_NeedDataSource" EnableEmbeddedSkins="False">

<%@ Page Title="" Language="C#" MasterPageFile="~/University/Request/MasterPages/CMSEditInfoRequest.Master" AutoEventWireup="true" CodeBehind="RejectedEditReport.aspx.cs" Inherits="IAUEC_Apps.UI.University.Request.CMS.RejectedEditReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div dir="rtl">
        <asp:Panel ID="pnl_Main" runat="server">
            ...
            <telerik:RadGrid ID="grd_RejectEdit" runat="server" FilterItemStyle-Height="23px" AllowPaging="true" PageSize="20" AllowFilteringByColumn="True" AutoGenerateColumns="False" OnNeedDataSource="grd_RejectEdit_NeedDataSource" EnableEmbeddedSkins="False">
                <MasterTableView HeaderStyle-Font-Bold="true" Width="100%">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn AllowFiltering="false" DataField="EditeTypeName" FilterImageUrl="Filter.gif" HeaderText="نوع ویرایش" SortAscImageUrl="SortAsc.gif" SortDescImageUrl="SortDesc.gif">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn AllowFiltering="false" DataField="NewContent" FilterImageUrl="Filter.gif" HeaderText="عبارت جدید" SortAscImageUrl="SortAsc.gif" SortDescImageUrl="SortDesc.gif">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn AllowFiltering="false" DataField="Tozihat" FilterImageUrl="Filter.gif" HeaderText="علت رد" SortAscImageUrl="SortAsc.gif" SortDescImageUrl="SortDesc.gif">
                        </telerik:GridBoundColumn>
                    </Columns>
                </MasterTableView>
                <PagerStyle FirstPageImageUrl="PagingFirst.gif" LastPageImageUrl="PagingLast.gif" NextPageImageUrl="PagingNext.gif" PrevPageImageUrl="PagingPrev.gif" />

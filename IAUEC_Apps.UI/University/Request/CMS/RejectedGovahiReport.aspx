<%@ Page Title="" Language="C#" MasterPageFile="~/University/Request/MasterPages/CMSGovahiRequestMaster.Master" AutoEventWireup="true" CodeBehind="RejectedGovahiReport.aspx.cs" Inherits="IAUEC_Apps.UI.University.Request.CMS.RejectedGovahiReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div dir="rtl">
        <asp:Panel ID="pnl_Main" runat="server">
            ...
            <telerik:RadGrid ID="grd_RejectGovahi" Skin="MyCustomSkin" runat="server" AllowPaging="true" PageSize="20" AllowFilteringByColumn="True" AutoGenerateColumns="False" OnNeedDataSource="grd_RejectGovahi_NeedDataSource" EnableEmbeddedSkins="False">
                <MasterTableView HeaderStyle-Font-Bold="true" Width="100%">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn AllowFiltering="false" DataField="PostNumber" FilterImageUrl="Filter.gif" HeaderText="علت رد یا ویرایش درخواست" SortAscImageUrl="SortAsc.gif" SortDescImageUrl="SortDesc.gif">
                        </telerik:GridBoundColumn>

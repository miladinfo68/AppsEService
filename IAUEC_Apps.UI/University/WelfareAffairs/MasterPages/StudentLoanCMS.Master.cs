...
{
    public partial class StudentLoanCMS : System.Web.UI.MasterPage
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            {
                Session[sessionNames.appID_Karbar] = "14";
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (cat != dt.Rows[i]["CategoryId"].ToString())
                    {
                        ...
                        cat = dt.Rows[i]["CategoryId"].ToString();
                        lstreportMenu.Text += "<li><a>" + dt.Rows[i]["CategoryName"].ToString() + "<span class='fa fa-chevron-down'> </span></a><ul class='nav child_menu' style='display: none'>";
                        lstreportMenu.Text += "  <li><a href='" + "../../WelfareAffairs/CMS/" + dt.Rows[i]["MenuLink"].ToString() + "?id=" + generaterandomstr(8) + "@A" + dt.Rows[i]["MenuId"].ToString() + "-" + generaterandomstr(8) + "'><span>" + dt.Rows[i]["MenuName"].ToString() + "</span></a></li>";
                    }
                    else
                        lstreportMenu.Text += "  <li><a href='" + "../../WelfareAffairs/CMS/" + dt.Rows[i]["MenuLink"].ToString() + "?id=" + generaterandomstr(8) + "@A" + dt.Rows[i]["MenuId"].ToString() + "-" + generaterandomstr(8) + "'><span>" + dt.Rows[i]["MenuName"].ToString() + "</span></a></li>";
                }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WalletTransactions.aspx.cs" Inherits="IAUEC_Apps.UI.University.Wallet.CMS.WalletTransactions" MasterPageFile="~/University/Tuitional/masterPages/tuitionalMasterpage.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="PageTitle">گزارش تراکنش ها</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div dir="rtl">
        <telerik:RadGrid runat="server" ID="trgTransactions" AutoGenerateColumns="false" OnNeedDataSource="trgTransactions_NeedDataSource" AllowPaging="true" AllowFilteringByColumn="true" AllowSorting="true"
            EnableEmbeddedSkins="false" Skin="MyCustomSkin" OnItemDataBound="trgTransactions_ItemDataBound" PageSize="30" OnExcelMLWorkBookCreated="trgTransactions_ExcelMLWorkBookCreated">

(function () {
    ...
    function canvasHPad(el, opts) {
        ...
        opts.height = (opts.width / 1.95); /*|| opts.width * opts.aspectRatio;*/
     ...
     */
    canvasHPad.prototype.undo = function () {
     ...
     */
    canvasHPad.prototype.redo = function () {
    ...
    /**
     * Clear the canvasHPad
     */
    canvasHPad.prototype.clear = function () {
    ...
    /**
     * Convert the canvasHPad to a JSON object that can be loaded into
     * other canvasHPads or stored on a server
     */
    canvasHPad.prototype.toJSON = function () {
        return {
    ...
    /**
     * Load a json object into the canvasHPad
     * @return {object} - JSON object to load
     */
    canvasHPad.prototype.loadJSON = function (data) {
     ...
     */
    canvasHPad.prototype.setLineSize = function (size) {
     ...
     */
    canvasHPad.prototype.setLineColor = function (color) {
     ...
     */
    canvasHPad.prototype.drawLine = function (start, end, lineOpts) {
     ...
     */
    canvasHPad.prototype.resize = function (width) {
    ...
    if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
        module.exports = canvasHPad;
    } else {
        window.canvasHPad = canvasHPad;
    }
})();

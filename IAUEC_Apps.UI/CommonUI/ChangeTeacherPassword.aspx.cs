...
{
    public partial class ChangeTeacherPassword : System.Web.UI.Page
    {
        ...
        protected void btn_Change_Click(object sender, EventArgs e)
        {
            ...
            if (Session["password"].ToString() == txt_OldPass.Text)
            {
                if (txt_NewPass.Text == txt_ConfNewPass.Text)
                {
                    try
                    {
                        //if (cmb.ChangeTeacherPassword(int.Parse(Session[sessionNames.userID_StudentOstad].ToString()), txt_NewPass.Text))
                        if (cmb.ChangeTeacherPassword(int.Parse(Session[sessionNames.userID_StudentOstad].ToString()), txt_NewPass.Text))//, CommonBusiness.EncryptPass(txt_NewPass.Text))
                        {
        ...
        protected void btnReturn_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(ViewState["lastUrl"].ToString());
            else

...
namespace IAUEC_Apps.Business.Common
{
    public class EncryptionClass
    {
        ...
        static public String DecryptRJ256(byte[] cypher)
        {
            ...
            string key = "2960de5dcdf7ddb6bfeac167b1054f76";
            string IV = "762ed967e23c018417b487d65ad1a358";
        ...
        public static string EncryptAES256(string prm_text_to_encrypt, byte[] key, byte[] iv)
        {
            ...
            byte[] plainBytes = Encoding.ASCII.GetBytes(prm_text_to_encrypt);
